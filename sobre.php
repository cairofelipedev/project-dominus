  ...
  <body>
    ...
    <section class="py-6">
      <div class="container">
        ...
        <h2>Quem somos</h2>
        <p>
            Somos muito mais que uma distribuidora, somos a Dominus.
            Nascemos de um sonho para desenvolver e melhorar os negócios no Piauí e Brasil.
            Acreditamos que podemos fomentar o desenvolvimento da nossa economia gerando oportunidades de negócios para todos. <br/>
        ...
        <p>
          ...
          Integridade. Cooperação. Inovação. Excelência. Simplicidade. Vontade de resolver problemas. O ideal de fazer o bem ao mundo.<br/>
          Desde a nossa concepção, temos por objetivo atuar com empreendedores, donos de organizações e consumidores para facilitar o acesso a produtos e serviços logísticos, para o motor de desenvolvimento econômico e social, nas mãos do maior número possível de pessoas.<br/>
          Nossas portas estão e estarão abertas às pessoas com brilho nos olhos, vontade e coração aberto, independente de suas origens, posição social ou decisões pessoais.<br/>
          Nosso comprometimento é com uma cultura de qualidade, foco no cliente, que assume os riscos de melhorias contínuas e incentiva a criatividade, a liderança, e, principalmente, o espírito empreendedor. Encorajamos pessoas a tomarem iniciativa, agirem e fazerem a diferença.<br/>
          Não importa onde você esteja, você pode ser um parceiro e cliente da DOMINUS.<br/>
          Esse é um convite ao empreendedorismo e co-criação.<br/>
          Com carinho,<br/>
          Dominus Distribuidora
        </p>
      </div>
    </section>
